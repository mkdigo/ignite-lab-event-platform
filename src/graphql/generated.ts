...
export type GetLessionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessionsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, slug: string, title: string, lessonType: LessonType, availableAt?: any | null }> };
...
export const GetLessionsDocument = gql`
    query GetLessions {
...
/**
 * __useGetLessionsQuery__
 *
 * To run a query within a React component, call `useGetLessionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessionsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetLessionsQuery(baseOptions?: Apollo.QueryHookOptions<GetLessionsQuery, GetLessionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessionsQuery, GetLessionsQueryVariables>(GetLessionsDocument, options);
      }
export function useGetLessionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessionsQuery, GetLessionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessionsQuery, GetLessionsQueryVariables>(GetLessionsDocument, options);
        }
export type GetLessionsQueryHookResult = ReturnType<typeof useGetLessionsQuery>;
export type GetLessionsLazyQueryHookResult = ReturnType<typeof useGetLessionsLazyQuery>;
export type GetLessionsQueryResult = Apollo.QueryResult<GetLessionsQuery, GetLessionsQueryVariables>;
